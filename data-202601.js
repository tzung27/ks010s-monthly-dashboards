...
const DATA_202601 = {
  ...
  members: {
    Aaron: {
      ...
      summary: { cases: 4, virtual: 8000, actual: 11500 },
      highlights: ["取得 SC-200 Microsoft 認證：安全營運分析員助理 (Microsoft Certified: Security Operations Analyst Associate) 認證 (NT$10,000)", "星詠數位遷移 (虛擬價值 NT$8,000)", "Microsoft 365 商務進階版導入會議 (NT$1,500)"],
    ...
    Lucas: {
      ...
      summary: { cases: 7, virtual: 41000, actual: 0 },
      highlights: ["展碁線上azure webnar (虛擬價值 NT$20,000)", "更新 Microsoft Certified: Azure Solutions Architect Expert 認證 (虛擬價值 NT$20,000)", "安心食品Azure搬遷討論 (虛擬價值 NT$1,000)"],
    ...
    Nick: {
      ...
      summary: { cases: 5, virtual: 12000, actual: 0 },
      highlights: ["花仙子 - github copilot 購買授權說明 (虛擬價值 NT$6,000)", "酷博樂 github copilot說明 (虛擬價值 NT$6,000)", "Azure 線上訓練營"],
      nextMonth: []
    },
    Adobe: {
  ...
  cases: {
    Aaron: [
      {id:"A001",date:"2026-01-15",client:"取得",service:"取得 SC-200 Microsoft 認證：安全營運分析員助理 (Microsoft Certified: Security Operations Analyst Associate) 認證",virtual:0,actual:10000,category:"Microsoft Security"},
      {id:"A002",date:"2026-01-26",client:"GWS",service:"GWS to M365搬遷討論",virtual:0,actual:0,category:"Microsoft 365",note:"針對 Google Drive、Google Chat 等搬遷細節詢問"},
      {id:"A003",date:"2026-01-30",client:"Microsoft",service:"Microsoft 365 商務進階版導入會議",virtual:0,actual:1500,category:"Microsoft Security"},
      {id:"A004",date:"2026-01-07",client:"星詠數位遷移",service:"星詠數位遷移",virtual:8000,actual:0,category:"Microsoft"}
    ],
    Denny: [
    ...
    Lucas: [
      {id:"L001",date:"2026-01-16",client:"安心食品Azure搬",service:"安心食品Azure搬遷討論",virtual:1000,actual:0,category:"Azure"},
      {id:"L002",date:"2026-01-21",client:"展碁線上azure",service:"展碁線上azure webnar",virtual:20000,actual:0,category:"Azure"},
      {id:"L003",date:"2026-01-21",client:"azure",service:"azure 線上訓練營",virtual:0,actual:0,category:"Azure"},
      {id:"L004",date:"2026-01-22",client:"線上訓練營",service:"線上訓練營",virtual:0,actual:0,category:"Azure"},
      {id:"L005",date:"2026-01-23",client:"azure線上訓練營",service:"azure線上訓練營",virtual:0,actual:0,category:"Azure"},
      {id:"L006",date:"2026-01-27",client:"考取MS102",service:"考取MS102-Microsoft 365 系統管理員認證",virtual:0,actual:0,category:"Azure"},
      {id:"L007",date:"2026-01-21",client:"更新",service:"更新 Microsoft Certified: Azure Solutions Architect Expert 認證",virtual:20000,actual:0,category:"Azure"}
    ],
    Nick: [
      {id:"N001",date:"2026-01-05",client:"花仙子",service:"花仙子 - github copilot 購買授權說明",virtual:6000,actual:0,category:"GitHub Copilot",note:"說明github copilot授權指派與移除"},
      {id:"N002",date:"2026-01-12",client:"酷博樂",service:"酷博樂 github copilot說明",virtual:6000,actual:0,category:"GitHub Copilot"},
      {id:"N003",date:"2026-01-21",client:"Azure",service:"Azure 線上訓練營",virtual:0,actual:0,category:"Azure"},
      {id:"N004",date:"2026-01-22",client:"Azure",service:"Azure 線上訓練營",virtual:0,actual:0,category:"Azure"},
      {id:"N005",date:"2026-01-23",client:"Azure",service:"Azure 線上訓練營",virtual:0,actual:0,category:"Azure"}
    ],
    Adobe: [
