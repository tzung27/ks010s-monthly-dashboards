...
const DATA_202602 = {
  ...
  members: {
    Aaron: {
      ...
      summary: { cases: 5, virtual: 9500, actual: 1800 },
      highlights: ["易境永續 365 Copilot (虛擬價值 NT$5,000)", "M365 說明資安設定優化建議 (NT$1,500)", "坤侑科技 365 零信任介紹 (虛擬價值 NT$3,000)"],
    ...
    Lucas: {
      ...
      summary: { cases: 2, virtual: 10000, actual: 0 },
      highlights: ["更新 Microsoft Certified:Azure AI Engineer Associate 認證 (虛擬價值 NT$10,000)", "azure surestep Q3線上課"],
    ...
    Nick: {
      ...
      summary: { cases: 3, virtual: 12000, actual: 0 },
      highlights: ["鑫捷 github copilot 說明 (虛擬價值 NT$6,000)", "網際威信 github copilot 說明 (虛擬價值 NT$6,000)", "雲端知識課程"],
      nextMonth: []
    },
    Adobe: {
  ...
  cases: {
    Aaron: [
      {id:"A001",date:"2026-02-06",client:"Microsoft",service:"Microsoft 365 管理討論",virtual:0,actual:300,category:"Microsoft 365"},
      {id:"A002",date:"2026-02-11",client:"M365",service:"M365 說明資安設定優化建議",virtual:0,actual:1500,category:"Microsoft Security"},
      {id:"A003",date:"2026-02-12",client:"坤侑科技",service:"坤侑科技 365 零信任介紹",virtual:3000,actual:0,category:"Microsoft Security"},
      {id:"A004",date:"2026-02-25",client:"若谷資訊",service:"若谷資訊_M365線上會議",virtual:1500,actual:0,category:"Microsoft 365"},
      {id:"A005",date:"2026-02-26",client:"易境永續",service:"易境永續 365 Copilot",virtual:5000,actual:0,category:"Copilot for M365"}
    ],
    Denny: [
    ...
    Lucas: [
      {id:"L001",date:"2026-02-12",client:"azure",service:"azure surestep Q3線上課",virtual:0,actual:0,category:"Azure"},
      {id:"L002",date:"2026-02-26",client:"更新",service:"更新 Microsoft Certified:Azure AI Engineer Associate 認證",virtual:10000,actual:0,category:"Azure"}
    ],
    Nick: [
      {id:"N001",date:"2026-02-02",client:"鑫捷",service:"鑫捷 github copilot 說明",virtual:6000,actual:0,category:"GitHub Copilot"},
      {id:"N002",date:"2026-02-09",client:"雲端知識課程",service:"雲端知識課程",virtual:0,actual:0,category:"Copilot Studio"},
      {id:"N003",date:"2026-02-25",client:"網際威信",service:"網際威信 github copilot 說明",virtual:6000,actual:0,category:"GitHub Copilot"}
    ],
    Adobe: [
